...
use homm\hommformviewer\services\HommformviewerService as HommformviewerServiceService;
use homm\hommformviewer\models\Settings;
use homm\hommformviewer\models\HommformviewerModel;
 ...
 * @since     1.0.0
 *
 * @property  HommformviewerServiceService $hommformviewerService
	 ...
	 public function getCpNavItem()
{
   ...
   // $item['badgeCount'] = 5;
    ...
    public function init()
    {
		...
		$this->setComponents([
			'services' => \homm\hommformviewer\services\HommformviewerService::class,
			]);
